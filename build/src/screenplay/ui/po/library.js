...
var Library = /** @class */ (function () {
    ...
    Library.NEXT_BUTTON = protractor_1.Target.the('next button').located(protractor_2.by.xpath("//button[@class='ui blue icon right labeled button']"));
    ...
    Library.SELECT_ADDED_CREATIVES = protractor_1.Target.the('select a static creative').located(protractor_2.by.xpath("//div[contains(text(), 'download.jpeg')]"));
