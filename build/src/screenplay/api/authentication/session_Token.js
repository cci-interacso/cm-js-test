...
var oktaRequest_1 = require("../endpoints/requests/oktaRequest");
...
function AuthenticateApi() {
    return __awaiter(this, void 0, void 0, function () {
        var session_Token, access_Token, token, token1, token2, token3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSessionToken().then(function (res) {
                        return res.data.sessionToken;
                    })];
                case 1:
                    session_Token = _a.sent();
                    return [4 /*yield*/, getAccessToken(session_Token).catch(function (error) {
                            return error.request._currentUrl;
                        })];
                case 2:
                    access_Token = _a.sent();
                    token = access_Token;
                    token1 = token.split('access_token=');
                    token2 = token1[1].split('&');
                    token3 = token2[0];
                    return [2 /*return*/, token3];
            }
        });
    });
}
