...
export class Library {
    ...
    static SELECT_ADDED_CREATIVES = Target.the('select a static creative').located(by.xpath("//div[contains(text(), 'market.jpeg')]"));
    ...
    static STATIC_CREATIVE = Target.the('static creative').located(by.xpath("//*[contains(text(),'"+creative()+".jpeg')]"));
    static CREATIVE_IMAGE = Target.the('creative image').located(by.xpath("//*[contains(text(),'"+creative()+".jpeg')]/preceding::div[1]/img"))
